...
public sealed class CatalogService(ICatalogStore store)
{
    ...
    public InspectionModel UpdateModel(string tenantId, string code, UpdateCatalogEntryRequest body)
    {
        ...
        m.SortOrder = body.SortOrder is not null ? body.SortOrder.Value : m.SortOrder;
        m.UpdatedAt = Now();
        store.SaveModel(m);
        return m;
    }
    ...
    public InspectionSpec UpdateSpec(string tenantId, string code, UpdateCatalogEntryRequest body)
    {
        ...
        s.SortOrder = body.SortOrder is not null ? body.SortOrder.Value : s.SortOrder;
        s.UpdatedAt = Now();
        store.SaveSpec(s);
        return s;
    }
    ...
    public InspectionGrade UpdateGrade(string tenantId, string code, UpdateCatalogEntryRequest body)
    {
        ...
        g.SortOrder = body.SortOrder is not null ? body.SortOrder.Value : g.SortOrder;
        g.UpdatedAt = Now();
        store.SaveGrade(g);
        return g;
    }
    ...
    public InspectionBrand UpdateBrand(string tenantId, string code, UpdateCatalogEntryRequest body)
    {
        ...
        b.SortOrder = body.SortOrder is not null ? body.SortOrder.Value : b.SortOrder;
        b.UpdatedAt = Now();
        store.SaveBrand(b);
        return b;
    }
